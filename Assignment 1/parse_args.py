...
def parse_arguments():
    ...
    parser.add_argument('-e', '--epochs', type=int, default=27, help='Number of training epochs')
    ...
    parser.add_argument('-w_d', '--weight_decay', type=float, default=0.2, help='Weight decay used by optimizers.')
